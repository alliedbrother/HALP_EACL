#!/usr/bin/env python3
"""
Manual Review of LLama-3.2-11B-Vision Hallucination Dataset
...
def semantic_review(question, ground_truth, model_answer):
    ...
    if 'does not have' in gt_lower or 'without' in gt_lower or 'is not' in gt_lower:
        ...
        if 'hat' in gt_lower and 'hat' in question_lower:
            ...
            if 'no hat' in model_lower or "doesn't have" in model_lower or "does not show" in model_lower or 'not wearing' in model_lower:
...
# Main processing
print("="*80)
print("LLAMA-3.2-11B-VISION MANUAL REVIEW - LENIENT HALLUCINATION FLAGGING")
print("="*80)
print()

# Load dataset
input_file = Path('llama32_hallucination_dataset.csv')
output_file = Path('llama32_manually_reviewed.csv')
...
print()
print("="*80)
print("MANUAL REVIEW COMPLETE - LLAMA-3.2-11B-VISION")
print("="*80)
print(f"\nTotal entries: {total:,}")
...
print()
print("✅ LLAMA-3.2-11B-VISION MANUAL REVIEW COMPLETE")
