#!/usr/bin/env python3
"""
Build Hallucination Dataset CSV from Molmo-7B HDF5 Files
...
def build_hallucination_dataset(input_dir, output_csv):
    ...
    print("=" * 60)
    print("Building Hallucination Dataset for Molmo-7B-O-0924")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="Build hallucination dataset from Molmo-7B HDF5 files")
    parser.add_argument('--input-dir', type=str, default='./molmo_output',
                       help='Directory containing .h5 files')
    parser.add_argument('--output-csv', type=str, default='./molmo_hallucination_dataset.csv',
