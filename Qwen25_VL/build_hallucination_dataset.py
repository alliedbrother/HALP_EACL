#!/usr/bin/env python3
"""
Build Hallucination Dataset CSV from Qwen2.5-VL HDF5 Files
...
def build_hallucination_dataset(input_dir, output_csv):
    ...
    print("=" * 60)
    print("Building Hallucination Dataset for Qwen2.5-VL-7B")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="Build hallucination dataset from Qwen2.5-VL HDF5 files")
    parser.add_argument('--input-dir', type=str, default='./qwen25_output',
                       help='Directory containing .h5 files')
    parser.add_argument('--output-csv', type=str, default='./qwen25vl_hallucination_dataset.csv',
