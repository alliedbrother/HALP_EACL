#!/usr/bin/env python3
"""
Build Hallucination Dataset CSV from Phi4_VL HDF5 Files
...
def build_hallucination_dataset(input_dir, output_csv):
    ...
    print("=" * 60)
    print("Building Hallucination Dataset for Phi4_VL")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="Build hallucination dataset from Phi4_VL HDF5 files")
    parser.add_argument('--input-dir', type=str, default='./phi4_output',
                       help='Directory containing .h5 files')
    parser.add_argument('--output-csv', type=str, default='./phi4vl_hallucination_dataset.csv',
