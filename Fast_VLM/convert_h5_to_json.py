...
def main():
    parser = argparse.ArgumentParser(description='Convert FastVLM H5 files to JSON')
    parser.add_argument('--input', type=str, help='Input H5 file (optional, will convert all if not specified)')
    parser.add_argument('--input-dir', type=str, default='./fastvlm_output', help='Input directory containing H5 files')
    parser.add_argument('--output-dir', type=str, default='./fastvlm_output', help='Output directory for JSON files')
