#!/usr/bin/env python3
"""
Manual Review of Fast_VLM-7B Hallucination Dataset
...
def semantic_review(question, ground_truth, model_answer):
    ...
    no_patterns = ['no ', 'zero ', 'without ', 'none', 'not ', "isn't", "aren't", "doesn't", "don't see", 'not depicted', 'does not show']
    ...
    stopwords = {'the', 'a', 'an', 'is', 'are', 'was', 'were', 'in', 'on', 'at', 'to', 'of', 'and', 'or', 'i', 'you', 've', 'seems'}
...
# Main processing
print("="*80)
print("FAST_VLM-7B MANUAL REVIEW - LENIENT HALLUCINATION FLAGGING")
print("="*80)
print()

# Load dataset
input_file = Path('fastvlm_hallucination_dataset.csv')
output_file = Path('fastvlm_manually_reviewed.csv')
...
print()
print("="*80)
print("MANUAL REVIEW COMPLETE - FAST_VLM-7B")
print("="*80)
print(f"\nTotal entries: {total:,}")
...
print()
print("✅ FAST_VLM-7B MANUAL REVIEW COMPLETE")
